...
class DealReserve(BaseModel):
    ...
    # Alasan potongan bila hasil hitung WAJIB persetujuan manajer (SPR menunggu persetujuan).
    discount_reason: Optional[str] = None


class DealPricingDecision(BaseModel):
    approve: bool
...
class DealCancel(BaseModel):
    ...
    refund_mode: Optional[str] = None  # full | partial | forfeit (wajib bila booking fee dibayar)
